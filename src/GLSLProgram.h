...
{
    public:
        GLSLProgram(const char* vsource, const char* fsource, const char* gsource = NULL):prog_(0)
        {
            if ( !(prog_ = compile_program(vsource, fsource, gsource)) )
            {
